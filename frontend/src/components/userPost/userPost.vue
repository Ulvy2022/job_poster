                ...
                <div class="p-3  w-full">
                    ...
                    <div class="flex lg:gap-24 gap-7">
                        ...
                        <div class="lg:flex grid gap-y-4 lg:m-0 -ml-4 -mt-12">
                            <label for="my-modal-3" @click="getUserPostById(job.id)" class="w-full bg-blue-600 text-white  py-2 px-2 rounded focus:outline-none m-auto focus:shadow-outline">
                                Edit
                            </label>
    
                            <button type="submit"
                                class="w-full bg-red-600 lg:ml-2 text-white  py-2 px-2 rounded focus:outline-none m-auto focus:shadow-outline" @click="deleteUserPost(job.id)">
                                Delete
                            </button>
                        </div>
                    </div>
    ...
    <div class="mt-8 lg:w-[40%] w-full p-3 bg-white rounded-lg m-auto">
        <form @submit.prevent="">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    <p>{{data.job_title}}</p>
                    <label for="job-title" class="font-semibold block text-sm text-gray-900 dark:text-gray-300">Job Title</label>
                    <input v-model="jobTitleUpdate" type="text" id="job-title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Web Developer" required="">
                </div>

                <div>
                    <label for="job-location" class="font-semibold block text-sm text-gray-900 dark:text-gray-300">Job Location</label>
                    <input v-model="jobLocationUpdate" type="text" id="job-location" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Phnom Penh or Province" required="">
                </div>

                <div>
                    <label for="job-type" class="font-semibold block text-sm text-gray-900 dark:text-gray-300">Job Type</label>
                    <select v-model="jobTypeUpdate" id="job-type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Flowbite" required="">
                ...
                <div>
                    <label for="closing-date" class="font-semibold block text-sm text-gray-900 dark:text-gray-300">Job Closing Date</label>
                    <input v-model="jobCloseUpdate" type="date" id="closing-date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" >
                </div>
            
                <div>
                    <label for="salary" class="font-semibold block text-sm text-gray-900 dark:text-gray-300">Salary(per month)</label>
                    <input v-model="salaryUpdate" type="number" id="salary" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Salary">
                </div>

                <div>
                    <label for="contact-name" class="font-semibold block text-sm text-gray-900 dark:text-gray-300">Contact Name</label>
                    <input v-model="contactNameUpdate" type="text" id="contact-name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Name" required="">
                </div>

                <div>
                    <label for="contact-email" class="font-semibold block text-sm text-gray-900 dark:text-gray-300">Contact Email</label>
                    <input v-model="contactEmailUpdate" type="email" id="contact-email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Email">
                </div>

                <div>
                    <label for="company-name" class="font-semibold block text-sm text-gray-900 dark:text-gray-300">Company Name</label>
                    <input v-model="companyNameUpdate" type="text" id="company-name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Company Name">
                </div>
            </div>
            ...
            <div class="grid w-full gap-4 mb-6 grid-cols-1">
                ...
                <div class="w-full">
                    <label for="job-description" class="font-semibold block text-sm text-gray-900 dark:text-gray-300">Job Description</label>
                    <textarea v-model="jobDescriptionUpdate" name="" cols="30" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Job Description" required="">
                    </textarea>
                </div> 

                <div class="mb-1">
                    <label for="job-requirement" class="font-semibold block text-sm text-gray-900 dark:text-gray-300">Job Requirement</label>
                    <textarea v-model="jobRequirmentUpdate" name="" cols="30" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Job Requirement" required="">
                    </textarea>
                </div> 
                
                <div class="grid gap-12 grid-cols-2">
                    <div class="modal-action">
                        <label for="my-modal-3" type="submit" class="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm sm:m-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cancel</label>
                    </div>

                    <div class="modal-action">
                        <label for="my-modal-3" @click="editUserPost(data.id)" class="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm sm:m-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save</label>
                    </div>
                </div>                  
            </div>
        </form>
