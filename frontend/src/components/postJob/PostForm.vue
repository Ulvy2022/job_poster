                    ...
                    <div class="mt-8 lg:w-[40%] w-full p-3 bg-white rounded-lg m-auto">
                        <form @submit.prevent="createJob">
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                ...
                                <div class="w-full">
                                    <button @click="closeCreate" class="text-white w-full bg-red-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm sm:m-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cancal</button>
                                </div>
