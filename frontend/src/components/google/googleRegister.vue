        ...
        <div class="md:border md:border-gray-300 bg-white md:shadow-lg shadow-none rounded p-10" >
            ...
            <form class="my-8">
                <div class="relative mb-2">
                    <input id="password" class="w-full rounded px-3 border border-gray-300 pt-5 pb-2 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none input active:outline-none" type="password" autofocus>
                    <label for="password" class="label absolute mt-2 ml-3 leading-tighter text-gray-600 text-base cursor-text">Password</label>
                </div>
                <button @click='register' class="rounded text-white btn bg-blue-500 hover:bg-blue-600 text-sm">Register</button>
            </form>
        </div>
    </div>
</template>
