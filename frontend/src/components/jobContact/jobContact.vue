        ...
        <div class="flex  items-center cursor-pointer bg-slate-100 p-3">
            <div class="avatar placeholder ml-2">
                <div class="bg-neutral-focus text-neutral-content rounded-full w-16">
                    <span class="text-xl">{{jobDetails.company_name}}</span>
                </div>
            </div>
            ...
            <div class="grid">
                <div class="grid md:w-full shadow-lg shadow-gray-200">
                    <div>
                        ...
                        <p class="p-3 text-base"><b>{{jobDetails.company_name}} Address</b> - #9AB, 
                    ...
                    <div class="grid p-3">
                        ...
                        <div class="flex">
                            ...
                            <p class="ml-3 text-base">{{fname}} </p>
                        </div>
                    </div>
                    <!-- phone call -->
                    <div class="grid p-3">
...
export default {
    ...
    mounted() {
        axios.get('http://localhost:8000/api/postjob/' + localStorage.getItem('jobId')).then((res) => {
            ...
            this.fname = this.jobDetails.user.firstName + ' ' + this.jobDetails.user.lastName;
